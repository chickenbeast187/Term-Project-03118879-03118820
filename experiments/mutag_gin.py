...
def run_mutag_gin_experiment(
    ...
    for epoch in range(1, max_epochs + 1):
        ...
        if val_acc > best_val_acc:
            ...
            best_test_metrics = evaluate(model, test_loader)
            best_epoch = epoch
            epochs_no_improve = 0
        else:
            epochs_no_improve += 1
    ...
    print(
        ...
        f"Test F1-score: {best_test_metrics['f1']:.4f}\n"
        f"Test AUC:      {best_test_metrics['auc']:.4f}"
    )
